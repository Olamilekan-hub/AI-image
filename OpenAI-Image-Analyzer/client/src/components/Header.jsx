  ...
  return (
    <header className="fixed top-0 left-1/2 transform -translate-x-1/2 w-[90%] md:w-[60%] bg-black text-white p-1 shadow-md z-47 rounded-full mt-4 md:mt-7 font-poppins">
      <div className="flex justify-between items-center">
        ...
        <ul className="border-b-[0.5px] md:border-b-1 py-2 px-2 md:px-7 rounded-full shadow-md space-x-2 md:space-x-7 flex justify-center items-center">
        ...
        <button className="hover:bg-white py-1 md:py-2 px-1.5 md:px-3 rounded-full shadow-md hover:text-black font-semibold  border-white border-2 bg-black text-white transition duration-300">
