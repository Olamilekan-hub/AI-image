...
const Header = () => {
  return (
    <header className="fixed top-0 left-1/2 transform -translate-x-1/2 w-[90%] md:w-[60%] bg-gray-900 text-white p-1 shadow-md z-47 rounded-full mt-4 md:mt-7 font-poppins">
