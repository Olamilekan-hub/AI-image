  ...
  return (
    ...
    >
      ...
      id="First Ring" className="absolute h-[344px] w-[344px] md:w-[580px] md:h-[580px] border rounded-full border-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20">
        ...
        <div id="Circle on Ring 3(double)" className="absolute h-5 w-5 top-1/2 left-full border border-white  rounded-full -translate-x-1/2 -translate-y-1/2 inline-flex items-center justify-center">
